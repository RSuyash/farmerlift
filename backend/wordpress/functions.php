...
// =================================================================
// 2. FARMERLIFT CMS (REFACTORED MODULES)
// =================================================================
// All custom logic is now housed in the 'includes' directory.

$fl_includes = [
    '/includes/core.php',  // Post Types & Taxonomies
    '/includes/acf.php',   // Custom Fields
    '/includes/admin.php', // Administrative Tweaks
    '/includes/qr.php',    // QR Code Generator
    '/includes/api.php',   // Custom API Endpoints
    '/includes/crm/farmerlift-crm.php', // CRM Module
    '/includes/products/farmerlift-products.php', // Product Manager + SKU System
];

foreach ($fl_includes as $file) {
    $path = dirname(__FILE__) . $file;
    if (file_exists($path)) {
        require_once $path;
    } else {
        error_log("FarmerLift Warning: Missing include file " . $file);
    }
}
?>
